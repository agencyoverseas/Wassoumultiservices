// ============================================================
//  WASSOU SERVICE WORKER v2.3 — Agent IA + Nexus + sidebar
// ============================================================
const CACHE_NAME = 'wassou-v2-3';
const ASSETS = [
  ...
  './css/style.css',
  './js/app.js', './js/auth.js', './js/data.js', './js/payment.js',
  './js/nexus-secret.js', './js/sidebar.js',
